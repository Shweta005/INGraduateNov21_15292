--Create the friends table and add a children array
...
--Create a table called salary_employee with 3 fields name,pay_by_quarter which is an integer with one dimension
and 4 values and schedule which should be text field with 2 dimensions of no particular size.
...
--Insert some values into friends.
...
--Add a row into salary_employee.Bill who made 20,000 each quarter and 2 different schedule records of "meetig","training" and "lunch","sales call"
...
--Grab second child of all friends
SELECT children[2]
FROM friends;

--Grab the 2 and 3 element of pay_by_quarter using range from salary_employees table
SELECT pay_by_quarter[2:3]
FROM salary_employees;

--find dimensions and length of salary_employees
...
--Replace te children of Boyd in friends table.
UPDATE friends
...
--Replace Boyds second and third child
UPDATE friends
...
--Replace Bill's pay_by_quarter with values 22000,25000,27000,22000
...
--Update bill's 4th pay_by_quarter to 26000
UPDATE salary_employees
...
--Update bill's 2nd and 3rd quarter to 24000 and 25000
UPDATE salary_employees
...
--Search any of my friends have a child named Billy
SELECT *
FROM friends
...
----Search salary employee for anyone wih 'sales call' in the schedule
SELECT *
FROM salary_employees
